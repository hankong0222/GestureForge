...
$Body = @{ github_url = $GithubUrl } | ConvertTo-Json -Compress
Write-Host "Creating session for $GithubUrl"
$Created = Invoke-RestMethod -Method Post -Uri "$ApiBase/api/sessions/github" -ContentType "application/json" -Body $Body
